define(['angular', 'angularAnimate', 'angularRickshaw', 'angularUiTree', 'nvd3Directive'], function() {

    var monitoring_module = angular.module('compass.monitoring', [
        //'ui.router',
        //'ui.bootstrap',
        //'compass.charts',
        'ngAnimate',
    ...
    monitoring_module.config(function($stateProvider, $urlRouterProvider) {
        $stateProvider
    ...
    monitoring_module.controller('moniOverviewCtrl', function($scope, dataService, $stateParams) {
    ...
    monitoring_module.controller('topologyCtrl', function($scope, dataService, $stateParams) {
        var clusterId = $stateParams.id;
    ...
    monitoring_module.controller('alertsCtrl', function($scope, dataService, $stateParams) {
        var clusterId = $stateParams.id;
    ...
    monitoring_module.controller('metricsCtrl', function($scope, dataService, $stateParams) {
        var clusterId = $stateParams.id;
