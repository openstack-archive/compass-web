define(['angular'], function() {
    var clusterlist_module = angular.module('compass.clusterlist', [
        //'ui.router',
        //'ui.bootstrap',
        //'ngTable'
    ]);

    clusterlist_module.config(function($stateProvider, $urlRouterProvider) {
        $stateProvider
            .state('clusterList', {
                url: '/clusterlist',
    ...
    clusterlist_module.controller('clustersListCtrl', function($scope, $state, ngTableParams, $filter, dataService, allClusterData) {
