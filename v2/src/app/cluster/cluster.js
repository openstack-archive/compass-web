define(['angular'], function() {
    var cluster_module = angular.module('compass.cluster', [
        //'ui.router',
        //'ui.bootstrap',
        //'compass.charts',
        //'ngAnimate',
    ...
    cluster_module.config(function($stateProvider, $urlRouterProvider) {
        $stateProvider
            .state('cluster', {
                url: '/cluster/{id}',
    ...
    cluster_module.controller('clusterCtrl', function($scope, $state, dataService, $stateParams) {
    ...
    cluster_module.directive('clusternav', function($timeout) {
        return {
            restrict: 'EAC',
    ...
    cluster_module.controller('clusterLogCtrl', function() {

    })

    cluster_module.controller('clusterProgressCtrl', function($scope, dataService, $stateParams, $filter, ngTableParams, $timeout, $modal, clusterhostsData) {
        var clusterId = $stateParams.id;
        var progressTimer;
        var fireTimer = true;
    ...
    cluster_module.controller('createClusterCtrl', ['$scope', '$state', '$modal', '$log', 'dataService', 'wizardFactory', '$rootScope',
    ...
    cluster_module.controller('configurationCtrl', function($scope, dataService, $stateParams, $filter, ngTableParams, clusterhostsData) {
        var clusterId = $stateParams.id;
