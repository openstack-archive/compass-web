...
compassAppDev.run(function($httpBackend, settings, $http) {
    ...
    */
    ...
    $httpBackend.whenPOST(/\.*\/monit.*\/datapoints\/query\/tag$/).respond(function(method, url, data) {
        console.log(method, url, data);
    ...
    $httpBackend.whenPOST(/\.*\/monit.*\/datapoints\/query$/).respond(function(method, url, data) {
        console.log(method, url, data);
