define(['ngBsDaterangepicker', 'uiRouter', 'uiBootstrap', 'angularTable'], function(ngBsDaterangepicker) {
    'use strict';

    var userSetting_module = angular.module('compass.userSetting', [
        //'ui.router',
        //'ui.bootstrap',
        //'ngTable',
        'ngBootstrap'
    ...
    userSetting_module.config(function($stateProvider, $urlRouterProvider) {
        $stateProvider
            .state('userSetting', {
                url: '/userSetting',
    ...
    userSetting_module.controller('userSettingCtrl', function($scope, $state, ngTableParams, $filter, dataService, userSettingData, $modal) {
    ...
    userSetting_module.directive('match', function() {
        return {
            require: 'ngModel',
            restrict: 'A',
            scope: {
    ...
    userSetting_module.filter('timeStampFilter', function() {
