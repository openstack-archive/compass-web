define(['uiRouter', 'angularTable', 'angularDragDrop', 'angularTouch', 'ngSpinner', 'angularAnimate'], function() {
    var wizard_module = angular.module('compass.wizard', [
        'ui.router',
        'ui.bootstrap',
        'ngTable',
        //'compass.charts',
    ...
    wizard_module.config(function config($stateProvider) {
    ...
    wizard_module.controller('wizardCtrl', function($scope, dataService, wizardFactory, $stateParams, $state, $modal, clusterData, machinesHostsData, wizardStepsData, clusterConfigData) {
        console.log("in wizard ctl")
        $scope.loading = false;
    ...
    wizard_module.animation('.fade-animation', function() {
        return {
    ...
    wizard_module.controller('svSelectCtrl', function($scope, wizardFactory, dataService, $filter, ngTableParams, sortingService) {
    ...
    wizard_module.controller('globalCtrl', function($scope, wizardFactory, dataService, $q) {
        var cluster = wizardFactory.getClusterInfo();
    ...
    */
    ...
    wizard_module.controller('networkCtrl', function($scope, $timeout, wizardFactory, dataService, $filter, ngTableParams, sortingService, $q, $modal) {
        var cluster = wizardFactory.getClusterInfo();
    ...
    wizard_module.controller('partitionCtrl', function($scope, wizardFactory, dataService) {
        var cluster = wizardFactory.getClusterInfo();
    ...
    wizard_module.controller('securityCtrl', function($scope, wizardFactory, dataService) {
        var cluster = wizardFactory.getClusterInfo();
    ...
    wizard_module.controller('roleAssignCtrl', function($scope, wizardFactory, dataService, $filter, ngTableParams, sortingService, $q) {
        var cluster = wizardFactory.getClusterInfo();
        $scope.servers = wizardFactory.getServers();
    ...
    wizard_module.controller('networkMappingCtrl', function($scope, wizardFactory, dataService) {
        var cluster = wizardFactory.getClusterInfo();
        $scope.interfaces = wizardFactory.getInterfaces();
    ...
    wizard_module.controller('reviewCtrl', function($scope, wizardFactory, dataService, $filter, ngTableParams, sortingService) {
        var cluster = wizardFactory.getClusterInfo();
        $scope.servers = wizardFactory.getServers();
        $scope.interfaces = wizardFactory.getInterfaces();
        $scope.partition = wizardFactory.getPartition();
    ...
    wizard_module.directive('ngKeypress', function() {
    ...
    wizard_module.directive("rolepanelscroll", function($window) {
        return function(scope, element, attrs) {
