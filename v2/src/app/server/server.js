define(['uiRouter', 'uiBootstrap', 'angularTable'], function() {
    var server_module = angular.module('compass.server', [
        'ui.router',
        'ui.bootstrap',
        'compass.charts',
        'compass.findservers',
    ...
    server_module.config(function config($stateProvider) {
        $stateProvider
            .state('serverList', {
                url: '/serverlist',
    ...
    server_module.controller('serverCtrl', function($scope, dataService, $filter, ngTableParams, sortingService, machinesHostsData) {
