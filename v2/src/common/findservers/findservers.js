define(['angular'], function() {
    var findservers_module = angular.module('compass.findservers', [])
    findservers_module.directive('switchrow', function(dataService, $timeout) {
        return {
            restrict: 'A',
            scope: {
                polling: '=',
    ...
    findservers_module.directive('findservers', function(dataService, $modal, $log) {
        return {
            restrict: 'E',
            scope: {
