define(['angular', './common/gantt-chart-d3v2'], function(angular, g) {
    var charts_module = angular.module('compass.charts', [])

    charts_module.directive('piechart', function() {
        return {
            restrict: 'E',
            scope: {
                piedata: '='
    ...
    charts_module.directive('hostprogressbar', function(dataService, $timeout) {
        return {
            restrict: 'E',
            scope: {
                hostid: '=',
    ...
    charts_module.directive('circlepacking', function() {
        return {
            restrict: 'EAC',
            scope: {
                data: '=',
    ...
    charts_module.directive('treechart', function() {
        return {
            restrict: 'EAC',
            scope: {
                data: '=',
    ...
    charts_module.directive('ganttchart', function() {
        return {
            restrict: 'E',
            scope: {
                data: '=',
            ...
            link: function(scope, element, attrs) {
                ...
                function drawChart() {
                    ...
                    var gantt = g().taskTypes(hostnames).taskStatus(taskStatus).tickFormat(format).height(450).width(800);
