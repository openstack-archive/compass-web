///// @scratch /configuration/config.js/1
 // == Configuration
 // config.js is where you will find the core Metrics configuration. This file contains parameter that
 // must be set before Metrics is run for the first time.
 ///
define(['settings'],
function (Settings) {
...
*/
    ...
    grafana_index: "compass-met-dash",
