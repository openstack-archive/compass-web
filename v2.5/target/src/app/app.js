(function() {
  define(['angular', 'uiRouter', 'angularTable', 'angularCookies', 'uiBootstrap', 'angularDragDrop', 'app/controllers/all', 'app/services/all', 'app/factory/all', 'app/directives/all', 'app/filters/all'], function(ng) {
    'use strict';
    return ng.module("compass", ['ui.router', 'ngTable', 'ui.bootstrap', 'ngDragDrop', 'ngCookies', 'compass.controllers', 'compass.services', 'compass.factories', 'compass.directives', 'compass.filters']).config([
