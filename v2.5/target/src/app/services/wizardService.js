  ...
  define(['./baseService'], function() {
    ...
    WizardService = (function() {
      ...
      WizardService.prototype.networkMappingInit = function($scope) {
        ...
        $scope.networking = {};
        _ref1 = $scope.original_networking;
        for (key in _ref1) {
          value = _ref1[key];
        ...
        for (key in _ref2) {
          ...
          if (value.is_mgmt) {
            _results.push($scope.networking["management"].mapping_interface = key);
          } else {
      ...
      WizardService.prototype.networkMappingCommit = function($scope, sendRequest) {
