(function() {
  define(['angular', 'angularMocks'], function(ng) {
    'use strict';
    return ng.module('compass.testServer', ['ngMockE2E']).constant('settings', {
      apiUrlBase: '/api',
      metadataUrlBase: 'data',
      monitoringUrlBase: '/monit/api/v1'
    }).run(function($httpBackend, settings, $http) {
      ...
      return $httpBackend.whenGET(/\.*\/clusters\/[1-9][0-9]*\/state/).respond(function(method, url, data) {
        var progressData, states;
        console.log(method, url, data);
