define(['./baseService'], ()-> 
    ...
    class WizardService
        ...
        targetSystemConfigInit: ($scope) ->
            ...
            @dataService.getPackageConfigUiElements($scope.cluster.flavor.id).success (data) ->
                ...
                for key,value of $scope.metaData
                                    ...
                                    for details_content_data_key, details_content_data_value of content_data_value.content_data
                                        if details_content_data_key is content_data_value.default_value    
                                            for details_key, details_value of details_content_data_value
                                                # $scope.dropdown[details_content_data_key] = details_value
                    ...
                    # if value.category is "neutron_config"
                    #     if $scope.package_config["neutron_config"]["openvswitch"]["tenant_network_type"] is ""
                    #         $scope.package_config["neutron_config"]["openvswitch"]["tenant_network_type"]= "gre"
                    #         $scope.change("neutron_config","tenant_network_type",$scope.package_config["neutron_config"]["tenant_network_type"])
        ...
        reviewInit: ($scope) ->
            ...
            console.log($scope.cephConfig)
            console.log($scope.packageConfig)
        ...
        targetSystemConfigCommit: ($scope, sendRequest) ->
            ...
            # @wizardFactory.setPackageConfig($scope.package_config)
